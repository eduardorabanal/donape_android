...
public class ListaNecesidadActivity extends AppCompatActivity implements ListaNecesidadContract.View{
    SwipeRefreshLayout refreshLayout;
    RecyclerView rvList;
    ListaNecesidadAdapter adapter;

    ListaNecesidadContract.Presenter presenter;
    IPreferences preferences;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lista_necesidad);

        preferences = new Preferences(this);
        presenter = new ListaNecesidadPresenter(this, new ListaNecesidadInteractor(preferences));

        refreshLayout = findViewById(R.id.refresh);
        rvList = findViewById(R.id.rvList);
        rvList.setLayoutManager(new LinearLayoutManager(this));
        rvList.setLayoutAnimation(AnimationUtils.loadLayoutAnimation(this,R.anim.layout_fall_down));
        adapter = new ListaNecesidadAdapter(this);
